...
function DiscountTimer({ endDate, page = false }: DiscountTimerProps) {
    ...
    return (
        <div className={`${!page && "absolute top-0 left-0"} transform z-10 bg-red-600/40 backdrop-blur-sm text-white px-2 py-0.5 rounded-lg text-xs font-medium`}>
            <table className="border-collapse">
                <tbody>
                    <tr>
                        <td className="px-1 text-center">
                            <div className="flex flex-col items-center">
                                <span className="font-bold" dir="ltr">{timeLeft.days > 10 ? '+10' : timeLeft.days}</span>
