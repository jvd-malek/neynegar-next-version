...
function InternalLinkSelector({ onSelect, product = false, type, placeholder = "جستجو..." }: InternalLinkSelectorProps) {
    ...
    return (
        <div className="relative">
            ...
            {isOpen && (
                <div className={`${product ? "static" : "absolute"} z-50 w-full mt-1 bg-white border border-gray-300 rounded-md shadow-lg max-h-80 overflow-y-auto`}>
                    {isLoading && (
